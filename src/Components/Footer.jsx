...
export const Footer = () => {
  return (
    <div className='flex flex-col sm:h-40 justify-center items-center bg-secondary p-4'>
        <div className=' w-full md:w-1/2 flex flex-wrap justify-evenly items-center py-5 text-lg'>
